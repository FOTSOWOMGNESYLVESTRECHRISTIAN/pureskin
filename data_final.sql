-- =============================================
-- DONNÉES FINALES PURESKIN ÉTUDIANT
-- Ordre correct : catégories d'abord, puis produits
-- =============================================
...
-- Étape 2: Insérer les produits (avec les bons category_id)
...
-- Étape 3: Insérer les articles de blog
...
-- Étape 4: Insérer les témoignages
...
-- Étape 5: Insérer les routines de soin
